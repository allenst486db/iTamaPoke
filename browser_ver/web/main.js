...
createTPCore({
  ...
  fns = {
    ...
    kbText: mod.cwrap("tp_kb_text", "string", []),
    kbByteLen: mod.cwrap("tp_kb_byte_len", "number", []),
    kbCharLen: mod.cwrap("tp_kb_char_len", "number", []),
    kbJamoText: mod.cwrap("tp_kb_jamo_text", "string", ["number"]),
    nickCapacity: mod.cwrap("tp_nick_capacity", "number", []),
