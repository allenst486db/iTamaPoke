...
<div class="desktop">
  ...
  <div class="window">
    ...
    <div class="titlebar">
      ...
      <div class="tb-title">설치 가이드 — iTamaPoke v0.7.1</div>
    ...
    <div class="content">
      ...
      <header>
        <p class="eyebrow">INSTALL GUIDE · v0.7.1</p>
...
<span class="k">open</span> TamaPoke.xcodeproj</pre>
      ...
      <section>
        <div class="sec-head"><span class="sec-num">5</span><p class="kicker">Asset Script Options</p></div>
...
<span class="k">Scripts/fetch_assets.sh</span> --only sprites,shiny 25 25</pre>
      ...
      <section>
        <div class="sec-head"><span class="sec-num">6</span><p class="kicker">Troubleshooting</p></div>
        <h2>막히는 부분</h2>
        <div class="check">
      ...
      <footer>
        작성 기준: iTamaPoke v0.7.1. 한국어 원본 문서: <a href="INSTALL.ko.md">INSTALL.ko.md</a>. 게임 조작법은 <a href="GAMEPLAY.html">게임 설명서</a> 참고.
      </footer>
