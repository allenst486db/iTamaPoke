...
<div class="desktop">
  ...
  <div class="window">
    ...
    <div class="titlebar">
      ...
      <div class="tb-title">설치 가이드 — iTamaPoke v0.8.4</div>
    ...
    <div class="content">
      ...
      <header>
        <p class="eyebrow">INSTALL GUIDE · v0.8.4</p>
...
<span class="k">open</span> TamaPoke.xcodeproj</pre>
      ...
      <section>
        ...
        <div class="method">
          ...
          <p class="m-desc" style="font-size:.9rem;margin-bottom:.8rem"><strong>필수조건:</strong> 이미 이 저장소를 clone했습니다 (경로 C와 동일 — <code>git clone --recurse-submodules https://github.com/allenst486db/iTamaPoke</code> 후 <code>cd iTamaPoke</code>).</p>
          <div class="termwin">
            <div class="termbar"><span class="dots"></span><span class="tt">Terminal</span></div>
            <pre class="term"><span class="c"># 최초 1회: Emscripten SDK 설치</span>
<span class="k">git</span> clone --depth 1 https://github.com/emscripten-core/emsdk.git
<span class="k">cd</span> emsdk
./emsdk install latest
./emsdk activate latest
<span class="k">source</span> ./emsdk_env.sh

<span class="c"># iTamaPoke 저장소 폴더로 돌아가기</span>
<span class="k">cd</span> /path/to/iTamaPoke

<span class="c"># 코어 빌드 -&gt; browser_ver/web/tp_core.{{js,wasm}}</span>
<span class="k">bash</span> browser_ver/build.sh</pre>
          </div>
...
<span class="k">Scripts/fetch_assets.sh</span> --only sprites,shiny 25 25</pre>
      ...
      <footer>
        작성 기준: iTamaPoke v0.8.4. 한국어 원본 문서: <a href="INSTALL.ko.md">INSTALL.ko.md</a>. 게임 조작법은 <a href="GAMEPLAY.html">게임 설명서</a> 참고.
      </footer>
