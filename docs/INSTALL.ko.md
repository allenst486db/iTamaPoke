...
| 경로 | 필요한 것 | 시간 | 만료 | 애플워치 |
|---|---|---|---|---|
| **D 웹앱 / 안드로이드** ★ | 폰, 무료 GitHub 계정 | fork 10분 + 설치 1분 | 없음 | ✗ |
| A 무료 사이드로딩 | 아이폰, Mac 또는 Windows, 무료 Apple ID | 15분 | 7일마다 갱신 | ✗ |
| B 서명된 설치 | 유료 개발자 계정 | 10분 | 1년 | ✓ |
| C Xcode 직접 빌드 | Mac + Xcode | 20분 | 7일(무료 ID) | ✓ |
...
무료 Apple ID는 7일 후 만료되니 ⌘R을 다시 누르면 됩니다.
